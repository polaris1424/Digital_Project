...
testing:
manage.py test home.tests.frontend.test_chart_call_duration_time
"""
...
class TestChartCallDurationTrace(StaticLiveServerTestCase):
    ...
    def test_no_data_no_chart(self):
        ...
        self.selenium.get(f"{self.live_server_url}/dataAnalysis?clientId=9")
        chart = self.selenium.find_element(By.ID, "chart_call_duration_trace")
